...
class KDTree
{
  ...
  public:
    ...
    void copyTree(KDTreeNode * node1, KDTreeNode * node2);
    void deleteTree(KDTreeNode * node);
    KDTreeNode * buildTree(int left, int right, int d, vector<Point<Dim>>& pointsVec);
    void quickselect(int left, int right, int k, int d, vector<Point<Dim>> & pointsVec);
